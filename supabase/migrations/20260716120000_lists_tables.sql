...
-- The shared member-chosen Scope Policy enum (ADR-0007). Lists is the first
-- module to need it; it is a platform type, not a lists-local one, so future
-- member-chosen-scope modules reuse this same `public.scope`.
