 ...
 * shape is shareable and reload-stable. Carries a theme toggle since dark
 * mode is one of the things every prototype round needs judged.
 *
 * Lifted from the #113 recipe prototype round (commit 0ceddd5) unchanged
 * apart from this comment — same bar, same keys.
 */
