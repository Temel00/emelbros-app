 ...
 * direction is shareable and reload-stable. Also carries a theme toggle,
 * because #70 explicitly asks whether both grounds look deliberate and the
 * sign-in page renders no AppHeader to toggle from.
 */
